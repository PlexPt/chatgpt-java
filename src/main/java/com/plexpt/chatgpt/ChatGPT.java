...
import com.plexpt.chatgpt.exception.CommonError;
        ...
        client.addInterceptor(chain -> {
            ...
            if (!response.isSuccessful()) {
                if (response.code() == CommonError.OPENAI_AUTHENTICATION_ERROR.code()
                    ...
                    BaseResponse baseResponse = JSONUtil.toBean(response.body().string(),
                            BaseResponse.class);
                ...
                BaseResponse baseResponse = JSONUtil.toBean(errorMsg, BaseResponse.class);
